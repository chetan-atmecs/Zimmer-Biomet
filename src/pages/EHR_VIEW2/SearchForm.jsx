...
function SearchForm() {
  ...
  return (
    <form className={`flex flex-col justify-center items-center p-4 mt-4 ${color}  rounded-lg border border-solid border-white border-opacity-20 max-md:max-w-full`}>
