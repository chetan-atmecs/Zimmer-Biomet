  ...
  const handleSubmit = async (e) => {
    ...
    if (currentInputValue.trim() !== '') {
      ...
      if (apiResponse && !apiResponse.error) {
        // setRewardScore(apiResponse.response.normal.reward.score || 'N/A');
        // setEmotionScore(apiResponse.response.emotionalscore.Logit_Scale);
        // setEmpathyScore(apiResponse.responnormal.empathy.score.Empathy);
        // setEmotionScoreHover(JSON.stringify(apiResponse.emotionalscore))
        // setRewardScoreHover(JSON.stringify(apiResponse.normal.reward))
        // setEmpathyScoreHover(JSON.stringify(apiResponse.normal.empathy))
