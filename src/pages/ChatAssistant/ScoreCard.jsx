...
// function ScoreCard({ title, rewardScore,empathyScore ,message }) {
//   return (
//     <div className="flex flex-col p-4 sm:p-6 w-full text-base text-white rounded-lg border border-solid bg-white bg-opacity-30 border-white border-opacity-20 max-w-[542px]">
//       <div className="flex flex-col sm:flex-row gap-4 items-start w-full font-medium">
//         <div className="flex flex-1 gap-4 items-center pb-2 border-b border-white w-full sm:w-auto">
